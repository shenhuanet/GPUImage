 ...
 */
class GPUImageColorBalanceFilter : GPUImageFilter(NO_FILTER_VERTEX_SHADER, GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER) {

    private var mShadowsLocation: Int = 0
    private var mMidtonesLocation: Int = 0
    private var mHighlightsLocation: Int = 0
    private var mPreserveLuminosityLocation: Int = 0
    ...
    override fun onInit() {
        super.onInit()
        mShadowsLocation = GLES20.glGetUniformLocation(program, "shadowsShift")
        mMidtonesLocation = GLES20.glGetUniformLocation(program, "midtonesShift")
        mHighlightsLocation = GLES20.glGetUniformLocation(program, "highlightsShift")
        mPreserveLuminosityLocation = GLES20.glGetUniformLocation(program, "preserveLuminosity")
    }
