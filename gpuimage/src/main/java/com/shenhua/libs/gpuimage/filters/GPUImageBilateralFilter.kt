 ...
 */
class GPUImageBilateralFilter @JvmOverloads constructor(private var mDistanceNormalizationFactor: Float = 8.0f) : GPUImageFilter(BILATERAL_VERTEX_SHADER, BILATERAL_FRAGMENT_SHADER) {
    private var mDisFactorLocation: Int = 0
