 ...
 */
class GPUImageDilationFilter private constructor(vertexShader: String, fragmentShader: String) : GPUImageTwoPassTextureSamplingFilter(vertexShader, fragmentShader, vertexShader, fragmentShader) {
