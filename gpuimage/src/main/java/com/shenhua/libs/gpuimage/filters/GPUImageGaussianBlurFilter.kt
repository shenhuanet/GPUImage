 ...
 */
class GPUImageGaussianBlurFilter @JvmOverloads constructor(blurSize: Float = 1f) : GPUImageTwoPassTextureSamplingFilter(VERTEX_SHADER, FRAGMENT_SHADER, VERTEX_SHADER, FRAGMENT_SHADER) {
