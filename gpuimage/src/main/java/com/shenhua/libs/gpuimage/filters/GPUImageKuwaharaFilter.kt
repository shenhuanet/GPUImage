 ...
 */
class GPUImageKuwaharaFilter @JvmOverloads constructor(private var mRadius: Int = 3) : GPUImageFilter(GPUImageFilter.Companion.NO_FILTER_VERTEX_SHADER, KUWAHARA_FRAGMENT_SHADER) {
