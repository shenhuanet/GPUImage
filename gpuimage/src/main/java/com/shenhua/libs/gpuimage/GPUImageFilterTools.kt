...
import com.shenhua.libs.gpuimage.filters.*
import java.util.*
...
object GPUImageFilterTools {
    ...
    fun showDialog(context: Context,
        ...
        builder.setItems(filters.names.toTypedArray()
        ) { dialog, item ->
            listener.onGpuImageFilterChosenListener(
    ...
    fun createFilterForType(context: Context, type: FilterType): GPUImageFilter? {
        when (type) {
            ...
            GPUImageFilterTools.FilterType.SOBEL_EDGE_DETECTION -> return GPUImageSobelEdgeDetection()
            GPUImageFilterTools.FilterType.THREE_X_THREE_CONVOLUTION -> {
                val convolution = GPUImage3x3ConvolutionFilter()
                convolution.setConvolutionKernel(floatArrayOf(-1.0f, 0.0f, 1.0f, -2.0f, 0.0f, 2.0f, -1.0f, 0.0f, 1.0f))
                return convolution
            }
            ...
            GPUImageFilterTools.FilterType.HIGHLIGHT_SHADOW -> return GPUImageHighlightShadowFilter(0.0f, 1.0f)
            GPUImageFilterTools.FilterType.MONOCHROME -> return GPUImageMonochromeFilter(1.0f, floatArrayOf(0.6f, 0.45f, 0.3f, 1.0f))
            ...
            GPUImageFilterTools.FilterType.WHITE_BALANCE -> return GPUImageWhiteBalanceFilter(5000.0f, 0.0f)
            GPUImageFilterTools.FilterType.VIGNETTE -> {
                val centerPoint = PointF()
                centerPoint.x = 0.5f
                centerPoint.y = 0.5f
                return GPUImageVignetteFilter(centerPoint, floatArrayOf(0.0f, 0.0f, 0.0f), 0.3f, 0.75f)
            }
            ...
            GPUImageFilterTools.FilterType.BLEND_DIFFERENCE -> return createBlendFilter(context, GPUImageDifferenceBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_SOURCE_OVER -> return createBlendFilter(context, GPUImageSourceOverBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_COLOR_BURN -> return createBlendFilter(context, GPUImageColorBurnBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_COLOR_DODGE -> return createBlendFilter(context, GPUImageColorDodgeBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_DARKEN -> return createBlendFilter(context, GPUImageDarkenBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_DISSOLVE -> return createBlendFilter(context, GPUImageDissolveBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_EXCLUSION -> return createBlendFilter(context, GPUImageExclusionBlendFilter::class.java)


            GPUImageFilterTools.FilterType.BLEND_HARD_LIGHT -> return createBlendFilter(context, GPUImageHardLightBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_LIGHTEN -> return createBlendFilter(context, GPUImageLightenBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_ADD -> return createBlendFilter(context, GPUImageAddBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_DIVIDE -> return createBlendFilter(context, GPUImageDivideBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_MULTIPLY -> return createBlendFilter(context, GPUImageMultiplyBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_OVERLAY -> return createBlendFilter(context, GPUImageOverlayBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_SCREEN -> return createBlendFilter(context, GPUImageScreenBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_ALPHA -> return createBlendFilter(context, GPUImageAlphaBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_COLOR -> return createBlendFilter(context, GPUImageColorBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_HUE -> return createBlendFilter(context, GPUImageHueBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_SATURATION -> return createBlendFilter(context, GPUImageSaturationBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_LUMINOSITY -> return createBlendFilter(context, GPUImageLuminosityBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_LINEAR_BURN -> return createBlendFilter(context, GPUImageLinearBurnBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_SOFT_LIGHT -> return createBlendFilter(context, GPUImageSoftLightBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_SUBTRACT -> return createBlendFilter(context, GPUImageSubtractBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_CHROMA_KEY -> return createBlendFilter(context, GPUImageChromaKeyBlendFilter::class.java)
            GPUImageFilterTools.FilterType.BLEND_NORMAL -> return createBlendFilter(context, GPUImageNormalBlendFilter::class.java)

            GPUImageFilterTools.FilterType.LOOKUP_AMATORKA -> {
                val amatorka = GPUImageLookupFilter()
                amatorka.bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.lookup_amatorka)
                return amatorka
            }
    ...
    class FilterAdjuster(filter: GPUImageFilter) {
        ...
        init {
            ...
            } else if (filter is GPUImageTransformFilter) {
                adjuster = RotateAdjuster().filter(filter)
            } else {
